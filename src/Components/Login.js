...
function Login(props) {
  ...
  const handleApi = () => {
    ...
    axios
      .post("https://practeasebe.onrender.com/api/v1/user/login", {
        email: username,
        password: password,
      })
  ...
  return (
    <>
      ...
      <div className="text-quotes">
        <span>
          The people who are <br></br>crazy enough to think <br></br> they can
          change the <br></br> world are the ones <br></br> who do
        </span>
      </div>
      <div>
